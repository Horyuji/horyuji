...
const CONFIG = {
  ...
  files: [
    {pattern: `${process.cwd()}/bower_components/jquery/dist/jquery.js`, watched: false},
    {pattern: `${process.cwd()}/bower_components/bootstrap/dist/js/bootstrap.js`, watched: false},
